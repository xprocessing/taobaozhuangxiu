...
<div style="width:990px; height:122px; background-image:url(<? echo $_MODULE['wangwang_bg'] ?>); background-repeat:no-repeat;">
<table width="714" height="110" border="0" cellspacing="0" cellpadding="0" style="font-family:微软雅黑; font-size:14px; color:#000;">
  <tr>
    <td width="28">&nbsp;</td>
    <td width="263">&nbsp;</td>
    <td width="93" ><? echo $_MODULE['wangwang_title_01'] ;  ?></td>
    <td width="100"><?  echo $uriManager->supportTag($_MODULE['wangwangid_01'],"有问题旺我哦",1);	 ?></td>
    <td width="100"><?  echo $uriManager->supportTag($_MODULE['wangwangid_02'],"有问题旺我哦",1);	 ?></td>
    <td width="130"><?  echo $uriManager->supportTag($_MODULE['wangwangid_03'],"有问题旺我哦",1);	 ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
