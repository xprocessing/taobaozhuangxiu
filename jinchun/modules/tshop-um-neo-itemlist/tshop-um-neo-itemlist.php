...
/**
 ...
 2.根元素类定义包含：class="tb-module tshop-um tshop-um-neo-itemlist"（class属性可以添加您需要的类选择器定义）
 ...
 */
?>
<div class="tb-module tshop-um tshop-um-neo-itemlist">
 ...
 <?
	 ...
	 $items = $itemManager->queryByIds($ids,"hotsell");}
		...
		echo  '<div class="neo-item-desc">';
			...
			echo  '<div class="neo-discountprice">限时特价'.round($item->discountPrice,2).'元</div>';
